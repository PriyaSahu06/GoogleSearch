...
import Googlestart.Pages.GooglePopupPage;
import Googlestart.Pages.GoogleSearchPage;
import Googlestart.Pages.GoogleSearchResultPage;
...
public class RunTest {
	...
	public void startTest(Method m) {
		...
		GooglePopupPage popup = new GooglePopupPage(driver);
		popup.clickbutton();
